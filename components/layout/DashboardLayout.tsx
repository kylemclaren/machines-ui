      ...
      >
        <div className="flex flex-col h-full">
          ...
          <nav className="flex flex-col flex-1 px-2 pt-4 pb-4 overflow-y-auto">
            ...
            {/* Border separator between navigation and search - hidden on mobile */}
            <div className="mt-6 pt-2 border-t border-gray-200 dark:border-gray-700 hidden lg:block"></div>
            
            {/* Search button with border - hidden on mobile */}
            <div className="mt-3 px-2 hidden lg:block">
              <button
                className="flex items-center w-full px-3 py-2 text-sm text-gray-700 dark:text-gray-300 bg-gray-50 dark:bg-gray-800 rounded-md border border-gray-200 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 cursor-pointer"
                onClick={() => {
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 lg:hidden">
          <div className="flex items-center justify-between h-16 px-4">
            ...
            {/* Mobile header with search button */}
