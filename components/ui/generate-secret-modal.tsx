          ...
          <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-4 py-2">
            ...
            <DialogFooter className="mt-6 flex flex-col-reverse sm:flex-row gap-2 sm:gap-0">
              <Button
                ...
                onClick={handleClose}
                disabled={isSubmitting}
                className="w-full sm:w-auto sm:mr-2 border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 hover:bg-gray-50 dark:hover:bg-gray-600 cursor-pointer"
              >
                Cancel
              </Button>
              <Button
                type="submit"
                disabled={isSubmitting}
                className="w-full sm:w-auto bg-blue-600 hover:bg-blue-700 text-white dark:bg-blue-600 dark:hover:bg-blue-700 dark:text-white cursor-pointer"
              >
                {isSubmitting ? (
                  <>
